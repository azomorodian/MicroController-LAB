...
;      84 OCR1BL=0x00;
	OUT  0x28,R30
;      85 
;      86 // Timer/Counter 2 initialization
;      87 // Clock source: System Clock
;      88 // Clock value: Timer 2 Stopped
;      89 // Mode: Normal top=FFh
;      90 // OC2 output: Disconnected
;      91 ASSR=0x00;
	OUT  0x22,R30
;      92 TCCR2=0x00;
	OUT  0x25,R30
...
;     104 TIMSK=0x00;
	OUT  0x39,R30
;     105 
;     106 // Analog Comparator initialization
;     107 // Analog Comparator: Off
;     108 // Analog Comparator Input Capture by Timer/Counter 1: Off
;     109 // Analog Comparator Output: Off
;     110 ACSR=0x80;
	LDI  R30,LOW(128)
	OUT  0x8,R30
;     111 SFIOR=0x00;
